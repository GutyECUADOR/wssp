            ...
            if ($coincidenciatypeDOCUMENT == TRUE) //AGREGAR ENLACE SOLO SI ES NOTA DE CRÉDITO
            {
                ...
                if ($coincidenciaRUC == TRUE) 
                    ...
                    //NODOS XML QUE SE BUSCA
                     ...
                     $importeTotalCLAVE = "valorModificacion";
                       ...
                       if ($COINCIDENCIAclaveAcceso == TRUE) 
                            ...
                            $importetotalDOCUMENT = strip_tags(substr($nodoCOMPROBANTE, $COINCIDENCIAimporteTotal+18,20));
                            ...
                            $arraytotal[$cont][3]= "Nota de Crédito";
