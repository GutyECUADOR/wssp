       ...
       <table class="CSSTableGenerator" align="center">
		<tr>
                <td align="center" colspan="7">
                    ...
                    <form action="frm_resultadosencuesta.php" method="get">
                    ...
                    Fecha Inicio:
                    <input type="text" name="dateinicio"  class="tcal" id="fecha" value="<?php echo date("Y-m-d"); ?>" size="10" style="width:15%"/>
                    Fecha Fin:
                    <input type="text" name="datefin"  class="tcal" id="fecha2" value="<?php echo date("Y-m-d"); ?>" size="10" style="width:15%"/>
                    <br>
                    
                   <FIELDSET>
                    <LEGEND>Preguntas Disponibles</LEGEND>
                    </br>
                    <input name="CHK_PREG1" type="checkbox" onclick="marcar(this);" checked/> Habilitar/Deshabilitar todo.
                          <p align="justify"> 
                              <input name="CHK_PREG1" type="checkbox" checked/> A. Le saludaron al entrar al local?
                          <br />
                          <input name="CHK_PREG2" type="checkbox" checked/> B. La amabilidad y cordialidad de los asesores que le atendió fue?
                          <br />
                          <input name="CHK_PREG3" type="checkbox" checked/> C. El asesoramiento de los productos y promociones que le dieron fue?
                          <br />
                          <input name="CHK_PREG4" type="checkbox" checked/> D. Como fue la atención y eficiencia de la cajera?
                          <br />
                          <input name="CHK_PREG5" type="checkbox" checked/> E. Se despidieron por su nombre y le agradecieron por su compra?
                          <br />
                          <input name="CHK_PREG6" type="checkbox" checked/> F. La imagen personal del asesor le pareció?
                          <br />
                          <input name="CHK_PREG7" type="checkbox" checked/> G. Cómo calificaría el orden y la limpieza en general?
                          <br />
                          <input name="CHK_PREG8" type="checkbox" checked/> H. Con que frecuencia usted visita los locales de Kao Sport Center?
                          <br />
                          <input name="CHK_PREG9" type="checkbox" checked/> I. Conoce usted de la existencia de KAO en las redes sociales como Facebook y Twitter?
                          <br />
                          <input name="CHK_PREG10" type="checkbox" checked/>  Comentarios.
