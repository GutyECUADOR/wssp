...
if (!empty($_POST['txt_codseguridad'])) {
    ...
    $consulta_keyuser = "SELECT * FROM dbo.Empleados with (nolock) WHERE CodAlterno = '$cod_seguridad1' AND Codigo='$evaluadorapp'";
