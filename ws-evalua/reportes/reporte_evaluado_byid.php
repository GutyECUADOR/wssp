<?php
    ...
    $id_evaluado = filter_input(INPUT_GET,'seleccion_empleado_resultados');
    $empleado_busqueda = filter_input(INPUT_GET,'seleccion_empleado_modal'); 
    $empresa_select = filter_input(INPUT_GET,'seleccion_empresa'); 
  
    if ($empleado_busqueda == 'general'){
        /*Consulta que agrupa y muetra todos los empleados que existen en las evaluaciones*/
         $consulta_general = "SELECT A.empleado as codigo, MAX(C.Nombre) as EmpresaN, MAX(B.Apellido + B.Nombre) as empleado, MAX(A.cargo)as cargo, MAX(CONVERT(date, B.Fecha_Ing))as fechaIng FROM dbo.Evaluaciones as A with (nolock) INNER JOIN SBIOKAO.dbo.Empleados as B on A.empleado = B.Codigo INNER JOIN SBIOKAO.dbo.Empresas_WF as C on C.Codigo = B.Empresa_WF WHERE B.Empresa_WF = '$empresa_select' AND fecha BETWEEN '$dateini_modal' and '$datefin_modal' GROUP BY empleado ORDER BY empleado";
         $result_query = odbc_exec($conexion, $consulta_general);
         $num_reg_emp = odbc_num_rows($result_query);
    ...
    <header class="clearfix">
      ...
      <div id="contenedor_info">
            ...
            <div id="datos1">
              ...
              <div><span>EMPLEADOS EN REPORTE:</span> '. $num_reg_emp .'</div>
            </div>
      </div>    
    </header>
    <main>
    <div class="grupo-2">
        <table>
            <thead>
                <tr>
                  <th class="title-row" colspan="2">Cod.Emp</th>
                  <th class="title-row" colspan="3">Empleado</th>
                  <th class="title-row" colspan="3">Cargo</th>    
                  <th class="title-row" colspan="3">Fecha Ingreso</th>
              </tr></thead>' ;
            ...
            $name_emp = odbc_result($result_query,"EmpresaN");
            ...
            $html .= ' 
              <tr>
                  <th class="title-row color-asent" colspan="2">'.$cod_gen_emp.'</th>
                  <th class="title-row color-asent" colspan="3">'.$empleado_gen.'</th>
                  <th class="title-row color-asent" colspan="3">'.$cargo_gen.'</th>
                  <th class="title-row color-asent" colspan="3">'.$fechaIng_gen.'</th>
    ...
    $fecha_rep = odbc_result($result_query,"fecha");
    ...
    $formacion_5 = odbc_result($result_query,"formacion_5");
    ...
    $acc_correctiva = odbc_result($result_query,"ac_correctiva");
     ...
     if ($total_general_db <= 175 && $total_general_db >=140)
    ...
    <header class="clearfix">
      ...
      <div id="contenedor_info">
            ...
            <div id="datos1">
              ...
              <div><span>FECHA:</span> '.$fecha_rep.'</div>
            </div>
      </div>    
    </header>
    <main>
        ...
        <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="desc">Tiene conocimiento de las 10 Reglas de Atención al Cliente</td>
                <td class="ptn">'.$formacion_5.' / 10 </td>
              </tr>
            </tbody>
        </table>
        </div>
        ...
        <table>
            ...
            <tbody>
              <tr>
                ...
                <td class="ptn">'.$total_general_db.' / 175</td>
              </tr>
              <tr>
