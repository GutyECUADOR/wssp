    ...
    function insertRegistro(){
       ...
       if (isset($_POST['txt_CIRUC']) && !empty($_POST['txt_CIRUC']) && isset($_POST['select_empresaa']) && isset($_POST['seleccion_empleado'])){
            ...
            $observacion = $_POST['txt_observacion'];
                    ...
                    $insert_data_CAB = "INSERT INTO dbo.CAB_EJI (codigo, solicitante, fecha, empresa, empleado, observacion ,estado) VALUES ('$int_EJI','$solicitante','$fecha','$empresa','$empleadoEV','$observacion','0');";
