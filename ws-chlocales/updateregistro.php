...
require_once '../ws-admin/funciones.php';
$fechaActual = getDateNow();
session_start();

   
 
if (!empty($_POST['id_chklist']) && ($fechaActual > $_POST['date_chk'])) {
    ...
    echo "<script language = javascript>
            swal({  title: 'Campo requerido',
            text: 'Uno o mas campos requeridos no fueron ingresados o la peticion se realizo fuera de fecha',  
            type: 'error',    
            showCancelButton: false,   
            closeOnConfirm: false,   
            confirmButtonText: 'Aceptar', 
