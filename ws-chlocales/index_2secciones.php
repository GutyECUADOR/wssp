...
<head>
	...
	<title>CheckList Diario - Locales</title>
                            ...
                            <div class="tabbable"> <!-- Only required for left/right tabs -->
                                ...
                                <div class="tab-content">
                                        ...
                                        <div id="bloque">
                                            <div class="container-fluid">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <label class="h6" for="chk4">4.- CONTROL DE MATERIAL POP HE INFORMATIVOS</label>
                                                            <div class="bs-callout bs-callout-primary">
                                            ...
                                            <div>
                                                <input name="guardar" type="submit" id="btn-submit" value="Registrar CheckList de Ingreso">
                                            </div>
                                    ...
                                    <div class="tab-pane" id="tab2"> <!-- Seccion checlist de salida-->
                                        <br>    
                                        <form action="addregistroSalida.php" class="formulario" name="formulario_registro" method="POST">
                                            <div id="bloque">
                                                <div class="alert alert-info alert-dismissable">
                                                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                                                    <p class="centertext textsize15">Seleccione check list del dia anterior</p>
                                                </div>

                                                <div class="form-group">
                                                                <select class="form-control text-center" name="seleccion_chlentrada" id="seleccion_chlentrada" required>
                                            ...
                                            <div>
                                                <input name="guardar" type="submit" id="btn-submit" value="Registrar CheckList de Salida">
                                            </div>
                                        </form> <!-- Fin Formulario de Salida -->  
                                    </div> <!-- Fin de Tab-->
                                </div> <!-- tab-content --> 
