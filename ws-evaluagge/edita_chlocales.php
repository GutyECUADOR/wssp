	...
	<div class="contenedor-formulario">
		<div class="wrap">
            ...
            <!--SECCION DETALLE-->                     
		                ...
		                <div>
                                    <input name="guardar" type="submit" id="btn-submit" value="Actualizar">
				</div>
				</div>  
                            </div>
        ...
        <div class="fixed-action-btn">
            ...
            <ul>
                <li><a class="btn-floating grey" onclick="alert_sweet()" title="Test Function"><i class="material-icons">new_releases</i></a></li>
            </ul>
          </div>
